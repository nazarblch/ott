...
from src.ott.neural.networks.potentials import (
    BasePotential,
...
class ExpectileNeuralDual:
  ...
  def __init__(
    ...
    if start_step > 0:
      ...
      ckp_f = ckptr.restore(f"/home/jovyan/nazar/outputs5.2/{start_step}/state_f")
      ckp_g = ckptr.restore(f"/home/jovyan/nazar/outputs5.2/{start_step}/state_g")
  ...
  def train_fn(
    ...
    for step in tqdm(range(self.start_step + 1, self.num_train_iters + self.start_step + 1)):
      ...
      if step % 5000 == 3:
        ckptr = PyTreeCheckpointer()
        ckptr.save(
            f"/home/jovyan/nazar/outputs5.2/{step}/state_f",
            self.state_f,
            force=True,
        ...
        ckptr = PyTreeCheckpointer()
        ckptr.save(
            f"/home/jovyan/nazar/outputs5.2/{step}/state_g",
            self.state_g,
            force=True,
